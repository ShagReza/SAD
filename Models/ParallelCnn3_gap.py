...
def create_model(input_shape1, input_shape2, input_shape3, config, is_training=True):
    ...
    #Concatenate
    concatenated = layers.concatenate([x1, x2, x3],axis=-1) # axis????
#    concatenated  = layers.concatenate([concatenated12, x3],axis=-1)
    y=concatenated
