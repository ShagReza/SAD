...
##==========================
x_train = np.load('./Results_Stage4/x_SnNM_SadFeats_16053500370_noMVN.npy')
y_train = np.load('./Results_Stage4/y_SnNM_SadFeats_16053500370_noMVN.npy')

x_train, Mu, Sd = SF.MVN_general(x_train, ax=0)

#MuSd = np.concatenate([Mu, Sd], axis=-1)
#np.save('./Results_Stage4/MuSd_x_SnNM_SadFeats_16053500370_noMVN.npy', MuSd)
...
x_val = np.load('./Results_Stage4/x_SnNM_SadFeats_15050160320_val_noMVN.npy')
y_val = np.load('./Results_Stage4/y_SnNM_SadFeats_15050160320_val_noMVN.npy')
