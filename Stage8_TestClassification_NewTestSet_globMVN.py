...
##======================= global MVN
MuSd = np.load('./Results_Stage4/MuSd_x_SnNM_SadFeats_16053500370_noMVN.npy')
Mu = MuSd[:,:,0].reshape(MuSd.shape[0],MuSd.shape[1],1)
Sd = MuSd[:,:,1].reshape(MuSd.shape[0],MuSd.shape[1],1)
x_test = (x_test-Mu)/Sd
##=======================
...
#mdl = 'model_epoch_09_trn_0.9666_val_0.9465.hdf5'
#mdl = 'model_epoch_18_trn_0.9758_val_0.9490.hdf5'
mdl = 'model_epoch_30_trn_0.9852_val_0.9472.hdf5'
