...
function MatFeat= VAD_Drugman_ForPython(wave)
Fs=8000

WinL=512;         %for Fs=16000
Hopsize=160;     %for Fs=16000
...
MatFeat=[Harm' Clarity' LPerr' HPS' CPP' SRHVal1' SRHVal2']';
