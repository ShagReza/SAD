...
##==========================================
### speech
#x_test = np.load('./Results_Stage3/Test_speech_cx32_hop220.npy')
#y_test = np.zeros(x_test.shape[0])

#x_test = np.load('./Results_Stage3/Test_speechSS_cx32_hop2.npy')
#y_test = np.zeros(x_test.shape[0])
#
#x_test = np.load('./Results_Stage3/Test_speechmusicSS_cx32_hop1.npy')
#y_test = np.zeros(x_test.shape[0])

#### noise
#x_test = np.load('./Results_Stage3/Test_noise_cx32_hop27.npy')
#y_test = np.zeros(x_test.shape[0])+1
#
#### music
x_test1 = np.load('./Results_Stage3/Test_Speech2_n5_n10_log_cx32_hop80.npy')
x_test2 = np.load('./Results_Stage3/Test_Speech2_n5_n10_SadFeats_cx32_hop80.npy')
y_test = np.zeros(x_test1.shape[0])

#x_test = np.load('./Results_Stage3/Test_musicSS_cx32_hop3.npy')
