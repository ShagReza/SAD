...
##==========================================
#x_test = np.load('./Results_Stage4/x_SNM_powChroma_100260270_test.npy')
#y_test = np.load('./Results_Stage4/y_SNM_powChroma_100260270_test.npy')

x_test = np.load('./Results_Stage4/x_SM_1115_musan_log.npy')
y_test = np.load('./Results_Stage4/y_SM_1115_musan_log.npy')
...
mdl = 'model_epoch_49_trn_0.9999_val_0.9601.hdf5'
